...
import com.animeit.AnimeIT.service.AuthService;
import com.animeit.AnimeIT.service.RefreshTokenService;
...
public class AuthController {
	...
	public ResponseEntity<String> signup(@RequestBody RegisterRequest registerRequest) {
		...
		return new ResponseEntity<>("User Registration successful, Check your email for verification link", HttpStatus.OK);
	}
